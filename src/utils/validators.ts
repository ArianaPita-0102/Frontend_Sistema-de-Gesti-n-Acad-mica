...
export function notEmpty(value: string, label: string): ValidationResult {
  if (!value || value.trim() === "") {
...
export function validAge(edad: number): ValidationResult {
...
export function validCupo(cupo: number): ValidationResult {
